...
The single women's event that had the greatest variability in competitor's heights is Rowing Women's Coxed Fours, with a standard deviation of 10.87.
...
ggplot(swimmers, aes(x=year, y=mean_age, color=sex)) +
  geom_line()
